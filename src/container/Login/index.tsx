...
const Login: FC<PageProps> = ()  => {
  ...
  return (
    <>
          <ButtonPrimary className="px-12 font-hellix-light"
         ...
         <div
          ...
          >
            <div className="relative w-[46vw] my-6 mx-auto max-w-3xl">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-modal outline-none focus:outline-none p-6" style={{backdropFilter: 'blur(39px)', padding: '28px 45px 47px',width:'614px',height:'372px'}}>
                {/*header*/}
