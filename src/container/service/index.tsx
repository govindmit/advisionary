...
const Service: FC<PageHomeProps> = ({ className }) => {
    return (
        <div style={{ backgroundImage: 'url(/bg.png)' }} className={`nc-ServicePage h-full ${className}`} data-nc-id="ServicePage">
            <Header />
                ...
                <div className='px-[12rem] py-[50px] relative overflow-hidden'>
                    <div className='flex mt-12' >
                        <div>
                            ...
                            <h1 className='text-7xl font-bold text-[#4B8CCB] mb-6'>Solution</h1>
                            <span className='leading-7 text-[#ffffff78] text-base font-hellix-light'> Why Automated your compliance work ? </span>
                        </div>
                    </div>
            ...
            <section>
                <div className="px-[7.875rem] py-[50px]">
                    <div className='bg-[#1c1c1c] rounded-md px-16 pt-12 py-20'>
                        <div><span className='text-6xl font-bold leading-[156%] text-[#fff]'>Compliance teams are often </span></div>
                        <div><span className='text-lg font-medium w-1/2 block md:break-all leading-[156%] text-[#ffffff99] font-hellix-light text-[16px]'>Having a compliance officer it’s expensive & annoying. Subscribing to all AML tools to meet your regulatory requirement is expensive/time consuming. As an External AML Department we meet all your regulatory requirements and much more!
                        </span></div>
                    ...
                    <div className=' rounded-md px-16 pt-12 py-20'>
                        ...
                        <div className='mt-12 flex justify-between '>
                            <div className='flex flex-col pr-16'>
                                ...
                                <div className='mb-4'><span className='text-[1.375rem] font-medium text-[#fff] font-hellix-light'>Compliance Boutique </span></div>
                                <div><span className='leading-[156%] text-[#ffffff75] max-w-md-[297px] inline-block font-hellix-light'>We cover all your needs and much more. Our goal was to help fintech & crypto businesses access top notch policies & procedures & all compliance tools at an accessible price. 
</span></div>
                            </div>
                            <div className='flex flex-col pr-16'>
                                <div className='logo_sm mb-4'>
