    ...
    >
      ...
      <section>
        <div className="px-[12rem] py-[50px] relative overflow-hidden">
          <div className="flex mt-12">
            <div>
              <h1 className="text-7xl font-bold text-[#fff]">Solution </h1>
              <h1 className="text-7xl font-bold text-[#fff]">Compliance</h1>
              <h1 className="text-7xl font-bold text-[#9B7Ae4] mb-6">
                Solution
              </h1>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container m-auto  ">
          <div className="linear-purple rounded-lg relative  overflow-hidden w-full  px-24 py-16">
            <img
            ...
            <div className="flex flex-col pr-16">
              ...
              <div>
                <span
                  ...
                  className="text-[#ffffff] w-2/3 block mb-4 font-hellix-light text-lg"
                >
                ...
                <ul
                  className="text-[#ffffff] w-2/3 block mb-8 font-hellix-light text-lg ml-4 "
                ...
                >
                  ...
                  <li>
                    Package with Applicable Regulator - Virtual Office - AML/CFT
                  </li>
                  <li>
                    {" "}
                ...
                >
                  ...
                  well as our regular exchanges with the regulatory authorities,
                  are all structuring and essential elements for the missions we
                  offer our clients.
                </span>
              </div>
              <div></div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container m-auto  ">
          <div className="bg-[#111] rounded-lg relative  overflow-hidden w-full  px-24 py-16">
            <img
              src="/images/image_big_black_circle.svg"
              className="big_black_circle"
            />
            ...
            <div className="flex flex-col pr-16">
              ...
              <div>
                <span
                  ...
                  className="text-[#ffffff] w-2/3 block mb-4 font-hellix-light text-lg"
                >
                  We provide you with an end to end solution, starting from the
                  consulting and licensing stage and to the full technical
                  platform setup.
                </span>
                <ul
                  className="text-[#ffffff] w-2/3 block mb-8 font-hellix-light text-lg ml-4 "
          ...
          <div className="linear-purple rounded-lg relative  overflow-hidden w-full  px-24 py-16">
            ...
            <div className="flex flex-col pr-16">
              ...
              <div>
                ...
                >
                  <li className="mb-3">
                    First Step : Our specialists will perform a deep dive study
                    and will advise you on juridiction and the type of licence
                    that suits your business.
                  </li>
                  <li className="mb-3">
                    Second Step : Once the choice of Juridiction and Licence are
                    made, we will focus on drafting procedures, policies,
                    appointed MLRO or external AML departement and more. We can
                    also connect you with locals experts to cover specific
                    requests.
                  </li>
                  <li className="mb-3">
            ...
            <div className="flex flex-col pr-16">
              ...
              <div>
                <span
                  ...
                  className="text-[#ffffff] w-2/3 block mb-4 font-hellix-light text-lg"
                >
                  Let's start with 1 hour free consulting session to understand
                  your business and define your needs. This will help us get you
                  the best personnalized approach based on your requirements,
                  and to focus on the development of a comprehensive roadmap
